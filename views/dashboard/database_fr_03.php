...
<div class="py-3">
    <form method="post" enctype="multipart/form-data"
                    ...
                    <table class="table table-bordered fr-form">
                        <thead class="text-center frmtable">
                            ...
                            <tr>
                                ...
                                <th class="align-middle">Fr-03</th>
        ...
        <div class="row mb-3">
            <div class="col-12">
                <p class="text-primary"><i>แผนภาพแสดงโครงสร้างขององค์กรและหน้าที่ความรับผิดชอบ</i></p>
                
                <form method="post" enctype="multipart/form-data"
                    action="<?= base_url('dashboard/fr/' . $this->uri->segment(3)) ?>">
                    <div id="img-diagram" class="mb-3">
                            <?php if (@$rsGovermentFr[0]->org_diagram != null) { ?>
                                <br /><img src="/uploads/files/<?= @$rsGovermentFr[0]->org_diagram ?>" class="img-fluid">
                            <?php } ?>
                        </div>
                    <div class="form-group mb-3">
                        <a class="btn btn-secondary btn-sm" style="position:relative;" href="javascript:;"><i
                                class="bx bx-upload"></i><input type="file" name="org_diagram"
                                style="position:absolute;z-index:2;top:0;left:0;filter: alpha(opacity=0);-ms-filter:&quot;progid:DXImageTransform.Microsoft.Alpha(Opacity=0)&quot;;opacity:0;background-color:transparent;color:transparent;"
                                size="40" onchange="$(&quot;#img-diagram&quot;).html($(this).val());" class="error">
                            เลือกไฟล์</a><br />
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="hidden" name="fr_no" value="3">
