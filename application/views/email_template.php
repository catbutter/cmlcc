...
table, td { color: #000000; } @media (max-width: 480px) { #u_content_heading_1 .v-font-size { font-size: 22px !important; } #u_content_image_1 .v-src-width { width: auto !important; } #u_content_image_1 .v-src-max-width { max-width: 86% !important; } #u_content_text_2 .v-container-padding-padding { padding: 20px 10px 10px !important; } }
    </style>
...
<table id="u_content_heading_1" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 class="v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 35px; font-weight: 400;"><strong>Chiang Mai Low Carbon City<br /></strong></h1>
...
<table id="u_content_text_2" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tbody>
    ...
    <div class="v-font-size" style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
        <h2 style="margin-bottom:20px;">การทบทวนข้อมูลบัญชีของท่านได้รับการอนุมัติ</h2>

        <p style="">ขอแสดงความยินดี ทางเราทำการอนุมัติบัญชีของท่านเป็นที่เรียบร้อยแล้ว</p>
        <p style="margin-bottom:10px;">ท่านสามารถใช้งาน https://cm.lcc.3e.world/ ได้ตามปกติ</p>

        <p style="margin-bottom:20px;">ขอบคุณสำหรับความร่วมมือเป็นอย่างดี</p>

        <p style="margin-bottom:10px;">หากท่านต้องการความช่วยเหลือสามารถติดต่อสอบถามเราได้ที่ <br/>
หน่วยวิจัยเพื่อการจัดการพลังงานและเศรษฐนิเวศ มหาวิทยาลัยเชียงใหม่ (3E)<br/>
239 ถนนห้วยแก้ว ตำบลสุเทพ อำเภอเมืองเชียงใหม่ จังหวัดเชียงใหม่ 50200<br/>
โทร.053-942086</p>
        </p>
    </div>
...
<!--[if (mso)|(IE)]><td align="center" width="600" style="background-color: #23767a;width: 600px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
<div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
  <div style="background-color: #23767a;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
...
<table style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-font-size" style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="line-height: 140%;"><span style="color: #ffffff; line-height: 19.6px;">Copyright © 2019 3e.world. All rights reserved.</span></p>
  </div>
